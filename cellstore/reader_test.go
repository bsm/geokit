...
var _ = Describe("Reader", func() {
	...
	It("should find nearby", func() {
		...
		Expect(rs).To(ContainCells(
			1317624576600000281, 1317624576600000289,
			1317624576600000273, 1317624576600000225,
			1317624576600000313, 1317624576600000305,
			1317624576600000257, 1317624576600000217,
			1317624576600000265, 1317624576600000297,
		))
		...
		Expect(subject.Nearby(seedCellID-100, 4)).To(ContainCells(
			1317624576600000009, 1317624576600000001,
			1317624576600000121, 1317624576600000113,
		))

		Expect(subject.Nearby(seedCellID+1000, 4)).To(ContainCells(
			1317624576600000777, 1317624576600000769,
			1317624576600000761, 1317624576600000785,
		))

		Expect(subject.Nearby(1317624576600000059, 4)).To(ContainCells(
			1317624576600000057, 1317624576600000049,
			1317624576600000033, 1317624576600000073,
		))
	})
